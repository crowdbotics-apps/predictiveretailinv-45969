"""
Django settings for predictiveretailinv_45969 project.
...
ROOT_URLCONF = 'predictiveretailinv_45969.urls'
...
WSGI_APPLICATION = 'predictiveretailinv_45969.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "predictiveretailinv_45969 API",
    "DESCRIPTION": "API documentation for predictiveretailinv_45969 App",
    "VERSION": "v1",
}
